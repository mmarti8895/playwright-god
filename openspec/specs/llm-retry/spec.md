...
Defines the requirements for automatically retrying transient LLM provider failures in `plan` and `generate` CLI steps with configurable exponential backoff and structured stderr progress events.
